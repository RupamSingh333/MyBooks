...
module.exports.registerUser = async (req, res) => {
  ...
  try {
    ...
    if (user) {
      ...
      responseManagement.sendMail(req.body.email, req.body.first_name,
  ...
  try {
    ...
    if (user && user.hash && user.salt) {
      ...
      if (user.validatePassword(password)) {
        ...
        responseManagement.sendResponse(res,httpStatus.OK,messages.login_success,{token:token,user_data});

      }else{

        responseManagement.sendResponse(res,httpStatus.UNAUTHORIZED,messages.user_login_fail);
